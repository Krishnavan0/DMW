...
const BuyerOtp = () => {
  ...
  return (
    <>
      <div className="buyerotp">
        <div className="buyerotp_box">
          <div className="buyerotp_logo">
            <div className="buyerotp_name">DMW</div>
          </div>
          <div className="buyerotp_para">OTP</div>
          <Formik
